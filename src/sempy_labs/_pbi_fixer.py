...
def pbi_fixer(
    ...
    title = widgets.HTML(
        ...
        f'font-family:-apple-system,BlinkMacSystemFont,sans-serif;">Power BI Report Fixer'
        f'<span style="font-size:11px; font-weight:400; color:{gray_color}; '
        f'margin-left:10px;">v{__version__}</span></div>'
    )
